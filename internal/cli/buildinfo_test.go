...
func TestNewBuildInfoPreservesExplicitReleaseMetadata(t *testing.T) {
	info := NewBuildInfo("gaori", "1.2.3", "abc123", "2026-01-01T00:00:00Z")

	want := BuildInfo{Name: "gaori", Version: "1.2.3", Commit: "abc123", BuildDate: "2026-01-01T00:00:00Z"}
	if info != want {
...
func TestNewBuildInfoNormalizesGoModuleVersionPrefix(t *testing.T) {
	info := NewBuildInfo("gaori", "v1.2.3", "abc123", "2026-01-01T00:00:00Z")
