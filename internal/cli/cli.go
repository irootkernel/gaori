...
func Main(args []string, stdout, stderr io.Writer) int {
	return Run(args, stdout, stderr, NewBuildInfo("gaori", "0.1.14", "unknown", "unknown"))
}
...
func commandOptionNeedsValue(arg string) bool {
	...
	switch trimmed {
	case "tag", "parser", "summary", "failure", "older-than", "file", "reason", "rule", "log", "expect-span", "raw-log", "span", "timeout-sec", "sample":
		return true
	default:
		return false
	}
