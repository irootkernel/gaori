...
guardrails:
	...
	$(GO) test -count=1 ./internal/cli -run '^(TestAdHocParserAndTagsSelectRules|TestAdHocParserMissPreservesCommandResult|TestAdHocParserOptionValidationPreventsExecution|TestCleanCommandContract|TestMaterializeArtifactsExtractionErrorContract|TestNoisyRunsWriteBoundedTerminalArtifacts|TestOversizedFailedRunPreservesRawLog|TestOversizedPassingRunUsesBoundedExtraction|TestOversizedSummarizeUsesBoundedExtraction|TestParsersDetectOutputContainsNoRawLogText|TestParsersDetectReportsCandidatesWithoutArtifacts|TestRunAndSummarizeSelectRulesByAllTags|TestSummarizeRebuildsArtifactsFromRawLogOnly|TestRulesLifecycleCommands)$$'
