...
| `GAORI-REQ-RQRUL-009` | `TestRulesProposeFromSummaryStreamsLargeRawLog`; `TestRulesProposeFromSummaryAcceptsExtractorLineBoundaries`; `TestRulesProposeFromSummaryFailsClosedOnUntrustedEvidence`; `TestRulesProposeModesAreMutuallyExclusive`; `TestBinaryProposesRuleFromGeneratedFailureSummary`; `TestBinaryProposesRuleFromGeneratedLFTerminalFailureSummary` |
