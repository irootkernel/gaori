...
Open implementation items are recorded in `todo.md`, including the evidence required to promote the two Experimental parsers and the remaining AWAIT terminal-wait hardening and full-gate work. Standard MCP Tasks migration remains deferred behind explicit protocol, SDK, and host-support conditions. The delivery statement above is intentionally narrower than “Gaori provides every testing or orchestration capability.”
